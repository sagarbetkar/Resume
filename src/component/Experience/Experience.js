      ...
      <div>
        <section className="resume-section p-3 p-lg-5 d-flex flex-column" id="experience">
          <div className="my-auto">
            ...
            <div className="resume-item d-flex flex-column flex-md-row mb-5">
              <div className="resume-content mr-auto">
                ...
                <div className="subheading mb-3">Knoxpo</div>
                <p>
                  In Knoxpo, working on job portal website. Used technologies Node.js, MongoDB, React, Typescript,
                  Graphql, Docker. Managed source code via Git and development on Google Cloud Platform using Docker.
                </p>
              </div>
          ...
          <div className="resume-item d-flex flex-column flex-md-row">
            <div className="resume-content mr-auto">
              <h3 className="mb-0">Freelance Javascript Developer</h3>
            ...
            <div className="resume-date text-md-right">
              <span className="text-primary">August 2018 - March 2019</span>
            </div>
          </div>
          ...
          <div className="resume-item d-flex flex-column flex-md-row mb-5">
            <div className="resume-content mr-auto">
              ...
              <p>
                ...
                JavaScript and Angular JS. Develop HDFC Feedback form used Node.js, Angular JS. Develop HDFC Admin panel
                used Node.js and Angular JS.
              </p>
            </div>
            <div className="resume-date text-md-right">
